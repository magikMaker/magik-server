...
// console.log('response info', responseObject);

                // simple send file to client
                responseObject.response.write(responseObject.data);
                responseObject.response.end();

                //// use stream to be able to send larger files
                //var stream = fs.createReadStream(responseObject.filePath, {
                //    bufferSize: 64 * 1024,
                //    autoClose: true
                //});
                //
                //stream.on('open', function() {
                //    stream.pipe(responseObject.response);
                //});
                //
                //stream.on('error', function(err) {
                //    responseObject.response.end(err);
                //});
                //
            ...
            //console.log('buffer?', responseObject.data instanceof Buffer, typeof responseObject.data);

            //if(!responseObject.data instanceof Buffer){
